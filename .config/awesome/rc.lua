...
local function set_wallpaper(s)
    ...
    if beautiful.wallpaper then
        local wallpaper = "/home/metadeth/Pictures/wall/wall6.jpg"
...
globalkeys = gears.table.join(
    ...
    awful.key({ }, "XF86AudioRaiseVolume", function () awful.spawn.with_shell("pactl set-sink-volume @DEFAULT_SINK@ +2%") end,
              {description = "vol +", group = "launcher"}),
    ...
    awful.key({ }, "XF86AudioMute", function () awful.spawn.with_shell("pactl set-sink-mute @DEFAULT_SINK@ toggle") end,
              {description = "vol toggle", group = "launcher"}),
    -- Music
    awful.key({ }, "XF86AudioPlay", function () awful.spawn.with_shell("playerctl play-pause") end,
              {description = "play", group = "launcher"}),
    awful.key({ }, "XF86AudioNext", function () awful.spawn.with_shell("playerctl next") end,
              {description = "next", group = "launcher"}),
    awful.key({ }, "XF86AudioPrev", function () awful.spawn.with_shell("playerctl previous") end,
              {description = "prev", group = "launcher"}),
    -- Brightness
